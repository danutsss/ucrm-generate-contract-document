...
$customAttributes = $client['attributes'];
$customAttributeValueById = [];
...
<body>
    <div class="wrapper" style="page-break-inside: avoid;">
            ...
            <tbody>
                <tr>
                    <td class="header__heading" class="center">
                        <h1>ZERO SAPTE SERVICES S.R.L</h1>
        ...
        <table class="paragraph">
            <tbody>
                ...
                <tr>
                    <td colspan="3">
                        <p class="center">
                            ZERO SAPTE SERVICES S.R.L, cu sediul in <strong>Navodari, blvd. Mamaia Nord, Centrul de Afaceri, spatiul 01-05, jud. Constanta</strong>, J13/1003/2022,
                            <strong>CUI:</strong> RO45858226, Unicredit Navodari, BCR Navodari, <strong>CONT:</strong> RO51 RNCB 0119 1723 6788 0001, reprezentata de
        ...
        <h2>CONDITII GENERALE DE FURNIZARE A SERVICIILOR 07 ("CONDITII GENERALE") - ANEXA A.1</h2>
        <h3>1. Definitii: </h3>
        <p>
            ...
            <br>
            (i)&nbsp;<strong>Furnizor:&nbsp;</strong>ZERO SAPTE SERVICES S.R.L, persoana juridica parte a contractului
            ...
            <br>
            (k)&nbsp;<strong>Lista de tarife:&nbsp;</strong>lista tarifelor aferente serviciilor si echipamentelor 07
            disponibila accesand site-ul 07, apeland Serviciul Relatii cu Clientii sau la magazinele 07;
            <br>
            ...
            <br>
            (n)&nbsp;<strong>Optiuni:&nbsp;</strong>servicii suplimentare furnizate de catre 07;
            <br>
            ...
            <br>
            (t)&nbsp;<strong>Site-ul 07:&nbsp;</strong>https://www.ctaonline.ro, precum si alte site-uri indicate de
            07, dupa caz;
            <br>
            ...
            <br>
            (v)&nbsp;<strong>Serviciul "Relatii cu Clientii":&nbsp;</strong>serviciul telefonic oferit de 07 la numarul
        ...
        <p>
            ...
            <br>
            3.3. Daca 07 preda in custodie clientului echipamente &nbsp;<strong>("Echipamente 07")</strong>,
            07 este proprietarul echipamentelor 07 pe perioada custodiei, iar clientul nu va transfera
            catre terti dreptul de a folosi echipamentele 07. Daca cleintul produce deteriorari
            echipamentelor, va suporta contravaloarea reparatiilor efectuate de 07, iar daca acesta decide
            ...
            Clientul se obliga sa restituie echipamentele 07 date in custodie, in stare de functionare, in
            ...
            de tarife"). Clientul suporta toate riscurile legate de pieirea echipamentelor 07 pe durat
        ...
        <p>
            ...
            <br>
            (iii) sau la sediile / caseriile 07.
            <br>
            4.2. Tariful Abonamentului este stabilit in lei si nu include TVA. Furnizorul nu va modifica pretul
            Abonamentului pe parcursul Perioadei initiale S.C. 07 S.R.L. si va mentine acelasi tarif pe o
            perioada de 1 an de zile de la expirarea Perioadei initiale daca sunt indeplinite conditiile
            prevazute la Art. 2.1. In cazul devalorizarii semnificative a Leului in raport cu Euro, 07 poate
            ...
            de catre client din motive neimputabile 07. Clientul care pretinde ca nu a primit factura nu este
            exonerat de la plata contravalorii Serviciului, la cererea clientului, 07 putand elibera o copie
            a facturilor.
            <br>
            ...
            ca eventualele diferentesa fie corectate in urmatoarea factura emisa de 07. Necontestarea
        ...
        <p>
            ...
            adresa cu clientul, daca acestia inregistreaza datorii catre 07, inclusivdaca acestea rezulta din
        ...
        <p>
            7.1. 07 poate modifica unilateral contractul (ex.: tarifele, modalitatea de aplicare a acestora,
        ...
        <p>
            10.1. 07 are dreptul de a denunta unilateral contractul, cu o notificare prealabila scrisa de 2 (doua) zile, in urmatoarele situatii:
            <br>
            ...
            <br>
            10.5. In situatia in care serviciile nu pot fi activate in termenul mentionat la punctul 4 din formular din motive de natura tehnica, atat clientul cat si 07 au dreptul sa considere contractul incetat de drept, fara notificare prealabila, fara interventia instantei si alte formalitati si fara acordarea de daune interese. In aceasta situatie, 07 va restitui clientului contravaloarea taxelor de instalare si activare a serviciilor deja achitate, daca este cazul.
            <br>
            10.6. Daca contractul inceteaza, pentru unul sau mai multe servicii, inainte de expirarea perioadei initiale, urmare a rezilierii de catre 07 sau a denuntarii unilaterale de catre client (altfel decat in cazul in care nu este de acord cu majorarea tarifelor), si clientul a beneficiat de o oferta promotionala / discount pentru serviciul respectiv, clientul va fi obligat la plata unor despagubiri pentru incetarea contractului inainte de perioada minima, specificate in &nbsp;<strong>ANEXA A</strong>.
            <br>
        ...
        <p>
            ...
            <br>
            <strong>b)&nbsp;</strong>mutarea echipamentelor in alta locatie, fara acordul 07;
            <br>
            ...
            <br>
            14.4. Daca identifica o activitate frauduloasa, 07 are dreptul:
            <br>
            ...
            <br>
            <strong>d)&nbsp;</strong>sa ia masurile prevazute in politica de securitate a 07, de asemenea, clientul este responsabil pentru daunele rezultate din neindeplinirea obligatiilor asumate prin prezentul articol.
        </p>
        ...
        <p>
            16.1. Furnizorul raspunde de functionarea S.C. 07 S.R.L. serviciilor pana la punctul terminal de retea.
            <br>
        ...
        <h1>CONDITII GENERALE DE FURNIZARE A SERVICIILOR 07 ("CONDITII GENERALE") - ANEXA A.1</h1>
        ...
        <p>
            5.1. In plus, fata de drepturile si obligatiile mentionate in &nbsp;<strong>Conditiile Generale de Furnizare a Serviciilor 07</strong>, clientul se obliga:
            <br>
        ...
        <p>
            ...
            <br>
            7.2. Furnizorul are dreptul sa stearga orice informatie pe care clientul a introdus-o in retea, care poate determina functionarea necorespunzatoare a retelei 07 Communication.
            <br>
        ...
        <p>
            ART. 1. - ZERO SAPTE SERVICES S.R.L, cu sediul in&nbsp;<strong>Navodari, str. Midiei nr. 6, jud. Constanta</strong>, J13/1022/2017,
        ...
        <p>
            ART. 2. - Prin prezentul proces verbal, beneficiarul atesta bransarea la reteaua 07 si buna functionare a serviciilor:
        </p>
        <table>
            <tbody>
                <tr>
        ...
        <h3 class="center">ZERO SAPTE SERVICES S.R.L.</h3>
        ...
        <ul>
            <li>
                <h3>Ce date folosim pentru furnizarea serviciilor?</h3>
            </li>
        ...
        <ul>
            <li>
                <h3>Ce date folosim pentru acest scop?</h3>
            </li>
        ...
        <ul>
            <li>
                <h3>Ce date folosim pentru a realiza aceste rapoarte combinate?</h3>
            </li>
        ...
        <p>
            Compania care va prelucreaza datele este ZERO SAPTE SERVICES S.R.L. denumita si 07INTERNET.
            <br>
        ...
        <p>
            <strong>Catre:&nbsp;</strong> ZERO SAPTE SERVICES S.R.L <br />
